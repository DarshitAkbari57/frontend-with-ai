...
interface ActivityTicketModalProps {
  ticket: Ticket;
  activityId: number;
  isOpen: boolean;
  onClose: () => void;
  ...
  return (
    <div className="bg-white rounded-[24px] w-full max-w-5xl mx-4 flex flex-col md:flex-row max-h-[90vh] shadow-2xl overflow-hidden border border-slate-100 relative">
      ...
      <div className="flex-1 flex flex-col p-6 overflow-y-auto">
        ...
        <form id="activity-booking-form" onSubmit={handleSubmit} className="flex flex-col space-y-6 flex-1">
...
export function ActivityTicketModal({ ticket, activityId, isOpen, onClose }: ActivityTicketModalProps) {
    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 sm:p-6 pb-20 sm:pb-6">
      ...
      <div className="relative z-10 w-full flex justify-center animate-in fade-in zoom-in-95 duration-200">
        <Elements stripe={stripePromise}>
          <CheckoutForm ticket={ticket} activityId={activityId} onClose={onClose} />
        </Elements>
      </div>
    </div>
  );
